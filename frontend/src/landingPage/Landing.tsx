...
const s_hero =
  'flex flex-col gap-5 px-5 pb-10 pt-5 sm:px-14 sm:pb-12 sm:pt-8 md:px-28'
...
const s_subheading = 'max-w-2xl text-base leading-relaxed text-slate-500'

const s_carousel_wrapper =
  'relative z-10 flex flex-col gap-4 px-5 pb-10 sm:px-14 md:px-28'
