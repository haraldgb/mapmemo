...
export const RouteGame = () => {
  ...
  useRouteMapRendering({
    ...
    selectableJunctions: routeGameState.selectableJunctions,
    availableRoundabouts: routeGameState.availableRoundabouts,
    isReady: routeGameState.isReady,
    canReachDestination: routeGameState.canReachDestination,
    getJunctionsForRoundabout: routeGameState.getJunctionsForRoundabout,
    onJunctionClick: routeGameState.handleJunctionClick,
    onRoundaboutClick: routeGameState.handleRoundaboutClick,
