...
const s_ui_container =
  'pointer-events-none absolute inset-x-4 top-10 z-10 grid items-center gap-3 rounded-2xl bg-transparent px-4 py-3 text-center md:grid-cols-[1fr_auto_1fr] md:px-16'
